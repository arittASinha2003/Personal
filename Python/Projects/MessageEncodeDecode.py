...
txtMsg = Entry(f1, font = ('arial', 16, 'bold'), textvarisable = Msg, bd = 10, insertwidth = 4, bg = "powder blue", justify = 'right')
...
btnExit = Button(fi, padx = 16, pady = 8, bd = 16, fg = "black", font = ('arial', 16, 'bold'), width = 10, text = "Exit", bg = "red", command = qExit).grid(row = 7, column = 3)
