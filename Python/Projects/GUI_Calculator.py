from tkinter import *
root = Tk()
root.title("Aritta's Simple Calculator")

e = Entry(root, width = 35, borderwidth = 5)
e.grid(row = 0, column = 0, columnspan = 3, padx = 10, pady = 10)
e.insert(0, "Created by Aritta")
...
button_add = Button(root, text = "+", padx = 39, pady = 10, command = lambda:Button_Add(e.get()))
button_equal = Button(root, text = "=", padx = 99, pady = 20, command = lambda:Button_Equal(e.get()))
